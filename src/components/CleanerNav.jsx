...
export default function CleanerNav() {
  ...
  const onClockster = location.pathname === '/clockster'
  const onWork = !onTraining && !onClockster
      ...
      <div className="cnav-island">
        ...
        <div className="cnav-row">
          ...
          <div className="cnav-nav-links">
            <button
              className={`cnav-nav-link ${onWork ? 'active' : ''}`}
            ...
            <button
              className={`cnav-nav-link ${onClockster ? 'active' : ''}`}
              onClick={() => navigate('/clockster')}
            >
              <svg fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" width="14" height="14">
